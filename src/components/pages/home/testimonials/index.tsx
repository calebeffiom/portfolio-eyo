...
const Testimonials = () => {
    ...
    return (
        <section>
            <div className="bg-[#fecf5a] py-[100px]">
                <Container>

                    <div>
                        <div className="w-[100%] leading-tight mb-[80px]">
                            <h2 className="text-[60px] mb-[18px]">Testimonials </h2>
                            <motion.div
                                initial={{ width: 0 }}
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
                                            {testimonials.map((testimony, index) => (
                                                ...
                                                >
                                                    <div
                                                        key={index}
                                                        className="p-6 bg-white rounded-[30px] shadow-lg transform hover:scale-105 transition-transform duration-300 flex flex-col items-center text-center"
                                                    >
                                                        <div className="mb-6"><FaQuoteLeft className="text-3xl text-gray-800"/></div>
                                                        <p className="text-gray-700 mb-[20px]">{testimony.content}</p>
                                                        <h3 className="text-[15px] text-gray-800 font-bold mb-6">{testimony.author}</h3>
                                                    </div>
                                                </motion.div>
                                            ))}
                                        </div>
