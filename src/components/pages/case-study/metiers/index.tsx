        ...
        <section>
            <div className="pt-[50px] pb-[100px] text-start  bg-[#F2B7B4] ">
                ...
                <div className="bg-[#fff] shadow-lg w-[70%] mx-[auto] rounded-[30px] p-[30px]">
                        ...
                        <div>
                            <div className="mb-[30px]"><h2 className="text-[30px]">Métiers Bien-Être
                            ...
                            <div className="mb-[30px]">
                                ...
                                <div><p><span className="mr-[15px] font-normal">Client :</span><span>Métiers Bien-Être</span></p></div>
                                <div><p><span className="mr-[15px] font-normal">Industry :</span><span>Wellness Education (French-speaking markets)</span></p></div>
                                <div><p><span className="mr-[15px] font-normal">Role :</span><span>Growth Marketing Consultant </span></p></div>
                                <div><p><span className="mr-[15px] font-normal">Revenue Milestone :</span><span> £225,000 in course sales</span></p></div>
                                <div><p><span className="mr-[15px] font-normal">Channels :</span><span> Paid Ads (Meta + Google), Webflow, Creative Strategy, CRO</span></p></div>
                            </div>

                            <div className="mb-[30px]">
                                <div><h2 className="text-[20px] mb-[10px]">The Mission:</h2></div>
                                <div className="mb-[30px]">
                                    <p className="font-light">Métiers Bien-Être had a strong product, professional wellness certification courses but poor conversion rates. Despite heavy ad spend across Facebook and Instagram, the purchase rate remained disappointingly low. The issue? A scattered user experience, misaligned messaging, and zero funnel clarity. They weren’t short on traffic — they were short on strategy and structure.</p>
                                </div>
                                <div className="hidden">
                                    <h2 className="text-[20px] mb-[10px]">My Approach :</h2>

                                    <p className="font-light mb-[30px]"><span className="font-normal text-[18px] block mb-[7px]">Step 1 : Rebuilt the Funnel Foundation</span>
                                    ...
                                    <p className="font-light mb-[30px]"><span className="font-normal text-[18px] block mb-[7px]">Step 2 : Full-Funnel Paid Ad Strategy</span>
...
Key tactics included:
                                    ...
                                    <p className="font-light mb-[30px]"><span className="font-normal text-[18px] block mb-[7px]">Results</span>
                                        <ul className="list-disc leading-[2] my-[10px]">
